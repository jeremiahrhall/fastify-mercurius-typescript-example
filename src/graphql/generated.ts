...
export type HelloResponse = {
  ...
  anotherField?: Maybe<Scalars['String']>;
};
...
> = {
  hello?: Resolver<ResolversTypes['HelloResponse'], ParentType, ContextType, RequireFields<QueryhelloArgs, 'name'>>;
};

export type HelloResponseResolvers<
  ContextType = MercuriusContext,
  ParentType extends ResolversParentTypes['HelloResponse'] = ResolversParentTypes['HelloResponse']
> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  anotherField?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export interface Loaders<TContext = import('mercurius').MercuriusContext & { reply: import('fastify').FastifyReply }> {
  HelloResponse?: {
    message?: LoaderResolver<Scalars['String'], HelloResponse, {}, TContext>;
    anotherField?: LoaderResolver<Maybe<Scalars['String']>, HelloResponse, {}, TContext>;
  };
}
